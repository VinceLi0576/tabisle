...
// 🔴 这份名单少一个键，那个偏好就「存得进、换台机器读不回来」。新增偏好必须同时进 app.js 的 DEFAULTS 和这里。
const PREF_KEYS=['view','recentCollapsed','filterMode','folderView','inboxIndex','recentNote','inboxNote','pinnedNote','pinnedCollapsed','foldDefault','orgCols','deckTab','deckCollapsed','webEngine','aiStandard','aiTasks'];
