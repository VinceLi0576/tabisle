...
const PREF_KEYS=['view','recentCollapsed','filterMode','folderView','inboxIndex','recentNote','inboxNote','pinnedNote','pinnedCollapsed','foldDefault','orgCols','aiStandard','aiTasks'];
