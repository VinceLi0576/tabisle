...
(function (root) {
  ...
  const WRITES = /^(BACKUP_(RESTORE|CREATE|POLICY_SAVE|CLEAR_LOCAL|DELETE)|SYNC_(APPLY|NOW)|BOOKMARK_REMOVE|EDITOR_(SAVE|DELETE|DELETE_DUPLICATE|UNDO_DUPLICATE|NUDGE|FOLDER_UPDATE|FOLDER_CREATE)|WRITE_[A-Z]+)$/;
