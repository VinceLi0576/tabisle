// 回归：整理页开着的时候，任何一次重绘都不许把顶上那一整块放出来盖在上面。
// 病根是 renderOrganize/renderSearch 两条路各自算它该不该藏，都没看整理页开没开。
// 🔄 260915：最近访问／快捷方式／收集箱合成 #deck 一块，坑没变、名字变了。
